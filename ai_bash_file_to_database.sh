...
usage() {
    echo "Usage: $0 <ip_address> <aide> <fapolicyd>"
    echo "       OR set variables ip_address, aide, fapolicyd in the script"
    echo ""
    ...
    echo "  $0 '192.168.1.100' 'active' 'enabled'"
    exit 1
}
...
ensure_table_exists() {
    ...
    CREATE TABLE IF NOT EXISTS $TABLE_NAME (
        ...
        aide TINYINT(1) NOT NULL,
        fapolicyd TINYINT(1) NOT NULL,
